 ...
 */
final class Version20191128210951 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tym (id INT AUTO_INCREMENT NOT NULL, typ_id INT NOT NULL, vedouci_id INT DEFAULT NULL, jmeno VARCHAR(255) NOT NULL, popis TEXT DEFAULT NULL, adresa VARCHAR(255) DEFAULT NULL, INDEX IDX_6147C6C4278CD074 (typ_id), INDEX IDX_6147C6C47D25FE4B (vedouci_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
